...
ActiveRecord::Schema.define(version: 2018_10_31_165343) do
  ...
  create_table "category_users", id: :serial, force: :cascade do |t|
    ...
    t.index ["category_id", "user_id", "notification_level"], name: "idx_category_users_u2", unique: true
  ...
  create_table "embeddable_hosts", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "path_whitelist"
    t.string "class_name"
  end

  create_table "facebook_user_infos", id: :serial, force: :cascade do |t|
    t.integer "user_id", null: false
    ...
    t.string "location"
    t.text "website"
    t.index ["facebook_user_id"], name: "index_facebook_user_infos_on_facebook_user_id", unique: true
    t.index ["user_id"], name: "index_facebook_user_infos_on_user_id", unique: true
  end
  ...
  create_table "github_user_infos", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["github_user_id"], name: "index_github_user_infos_on_github_user_id", unique: true
    t.index ["user_id"], name: "index_github_user_infos_on_user_id", unique: true
  end
  ...
  create_table "google_user_infos", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["google_user_id"], name: "index_google_user_infos_on_google_user_id", unique: true
  ...
  create_table "post_replies", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id", "reply_id"], name: "index_post_replies_on_post_id_and_reply_id", unique: true
  end
  ...
  create_table "queued_posts", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["queue", "state", "created_at"], name: "by_queue_status"
    t.index ["topic_id", "queue", "state", "created_at"], name: "by_queue_status_topic"
  end
  ...
  create_table "twitter_user_infos", id: :serial, force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "screen_name", null: false
    ...
    t.index ["twitter_user_id"], name: "index_twitter_user_infos_on_twitter_user_id", unique: true
    t.index ["user_id"], name: "index_twitter_user_infos_on_user_id", unique: true
  end
  ...
  create_table "user_options", id: false, force: :cascade do |t|
    ...
    t.boolean "email_private_messages", default: true, null: false
  ...
  create_table "user_profiles", primary_key: "user_id", id: :integer, default: nil, force: :cascade do |t|
    ...
    t.index ["card_background"], name: "index_user_profiles_on_card_background"
    t.index ["profile_background"], name: "index_user_profiles_on_profile_background"
  end
